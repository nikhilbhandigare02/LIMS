...
class CurrentPasswordInput extends StatefulWidget {
  ...
  @override
  State<CurrentPasswordInput> createState() => _CurrentPasswordInputState();
}

class _CurrentPasswordInputState extends State<CurrentPasswordInput> {
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<UpdatePasswordBloc, UpdatePasswordState>(
      buildWhen: (current, previous) => current.currentPassword != previous.currentPassword,
      builder: (context, state) {
        return Container(
          ...
          child: TextFormField(
            ...
            onChanged: (value) {
              context.read<UpdatePasswordBloc>().add(CurrentPasswordEvent(currentPassword: value));
            },
